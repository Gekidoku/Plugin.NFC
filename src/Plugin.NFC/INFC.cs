...
public interface INFC
{
    ...
    /// NFC Options
    /// </summary>
    NfcOptions Options { get; set; }

    /// <summary>
    /// Enables legacy mode to support Mifare Classic 1k tags (read/write).
    /// </summary>
    /// <param name="value"></param>
    [Obsolete("Do not use anymore: set legacy mode using UseNfc(NfcOptions) in MauiProgram.cs")]
